...
<div class='oneline work_field'>
    {if !empty($edit)}
        <form action='structure/changearticle/{$edit}' method="POST" enctype="multipart/form-data">
            ...
            <div id='settings' style='display:none'>
                <div class='settings'>
                    <span class='settings-label'>Title</span> <input type='text' name='title' value='{$article.title}'>
                </div>
                <div class='settings'>
                    <span class='settings-label'>Иконка кнопки</span> <input type='file' name='logotip'>
                ...
                <div class='settings'>
                    <span class='settings-label'>Язык</span> <select name="language">
                        <option value="RU" {if $article.language=='RU'}selected{/if}>RU</option>
                        <option value="EN" {if $article.language=='EN'}selected{/if}>EN</option>
                    </select>
                </div>
                <div class='settings'>
                ...
                <div class='settings'>
                    <span class='settings-label'>Отображать на сайте</span> <input type='checkbox' name='visible' {if $article.visible}checked{/if}>
                </div>
            </div>
